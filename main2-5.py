...
plt.ylabel('IGD')
plt.xlabel('gen')
plt.title(label='DTLZ2, #var='+str(num_variables)+' ,#obj='+str(num_objectives)+' , div='+str(div)+' ,best: '+str("{0:.3f}".format(min(igds)))+'last: '+str("{0:.3f}".format(igds[-1])))
plt.savefig(str('DTLZ2:'+str(num_variables)))